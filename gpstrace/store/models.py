...
class Item(models.Model):
    ...
    price = models.DecimalField(max_digits=7, decimal_places=0, blank=True, null=True, verbose_name='Ціна товару')
    discount = models.DecimalField(max_digits=7, decimal_places=0, blank=True, null=True, verbose_name='Знижка у %')
